...
function makeTwo() {
	const spanOne = document.getElementById('practicum2');
	spanOne.textContent = 'Привет Мир!';
}
...
function makeThree() {
	const newH1 = document.querySelector('#practicum3');
	newH1.textContent = 'Заголовок изменен!';
}
...
function makeFour() {
	const elementColor = document.querySelector('#practicum4');
...
function makeFive() {
	const inputChange = document.getElementById('practicum5');
	inputChange.value = 'Новое значение';
}
...
function makeSeven() {
	const newLink = document.querySelector('#practicum7');
	newLink.href = 'https://www.google.com';
	newLink.textContent = 'Ссылка на Google';
}
...
function makeEight() {
	const listOne = document.getElementById('practicum8');
	let listLast = document.createElement('li');
	listLast.innerHTML = 'Новый элемент';
	listOne.append(listLast);
}
...
function makeNine() {
	//Найдите элемент
	const elementSelect = document.getElementById('practicum9');
...
function makeTen() {
	const divStyle = document.getElementById('practicum10');
...
function makeEleven() {
	const divWidthAndHeight = document.getElementById('practicum11');
	divWidthAndHeight.style.width = '400px';
	divWidthAndHeight.style.height = '200px';
}
...
function makeTwelve() {
	const divChange = document.querySelector('#practicum12');
	divChange.classList.toggle ('large');
}
...
function makeThirteen() {
	const olText = document.getElementsByTagName('ol')[0];
	olText.textContent = 'Первый!';
}
...
function makeFifteen() {
	...
	divElement.classList.remove('practicum15');
}
...
function makeSixteen() {
	const divElementOne = document.getElementById('practicum16');
	divElementOne.classList.add('practicum16');
}
...
function makeSeventeen() {
	const divElementTwo = document.getElementById('practicum17');
	divElementTwo.classList.toggle('color');
}
...
function makeEighteen() {
	const divElementThree = document.getElementById('practicum18');
	divElementThree.classList.toggle('active');
}
...
function makeNineteen() {
	const divElementFour = document.getElementById('practicum19');
	divElementFour.classList.remove('active');
}
...
function makeTwenty() {
	const divElementFive = document.getElementById('practicum20');
	const paragraph1 = document.createElement('p');
	paragraph1.innerHTML = 'Добавлено в начало';
	divElementFive.prepend(paragraph1);
...
function makeTwentyOne() {
	const divSix = document.getElementById('practicum21');
	const paragraph2 = document.createElement('p');
	paragraph2.innerHTML = 'Добавлено в конец';
	divSix.append(paragraph2);
}
...
function makeTwentyTwo() {
	...
	const scrAttribute =  image.hasAttribute('src');
	...
	resultElement.textContent = 'Атрибут "src" присутствует: ' + scrAttribute;
...
function makeTwentyThree() {
	const hrefDelete = document.getElementById('practicum23');
	hrefDelete.removeAttribute('href');
}
...
function makeTwentyFour() {
	const inputOne = document.getElementById('practicum24');
	inputOne.setAttribute('value', 'Новое значение');
}
...
function makeTwentyFive() {
	...
	divTwo.textContent = 'Добавленный атрибут: ' + dataInfoValue;
}
...
const parent = button.closest ('.b-26');
...
function makeTwentySeven() { 
	//Найдите переменную 
	const divElem = document.getElementById('practicum27'); 
	...
	const result = divElem.classList.contains('active') 
...
//Подсказка: Используйте метод addEventListener для добавления обработчика события. Чтобы проверить работу слушателя, нужно напечатать один символ и более в поле ввода и убрать фокус с инпута, кликнув на любое место страницы.
const lastDiv = document.getElementById('div30');
...
//Ваш код
lastDiv.addEventListener('mouseover', handleMouseOver);